...
<head>
    ...
    <title>Sum_Samsung</title>
    <link rel="stylesheet" href="/common/css/sum_css/sum_samsung.css">
</head>
<body>
   <!-- 로딩 html svg -->
<!--<div class="loader loader--style5 loading_control">
...
<!-- 로딩 html svg -->
    ...
    <div class="header" data-ix="show-nav">
        <div class="w-nav nav" data-collapse="medium" data-animation="over-right" data-duration="400" data-contain="1" data-doc-height="1" data-ix="nav-bar-load" data-easing="ease-out-quart" data-easing2="ease-out-quart">
            <div class="w-container">
                <a class="w-nav-brand w-clearfix brand" href="http://monster2jy.cafe24.com/" target="_blank">준영이쨩
                    <div class="brand-subtitle"></div>
                </a>
                <nav class="w-nav-menu nav-menu" role="navigation">
                    <a class="w-hidden-main w-inline-block close-link" href="#">
                        <div>✕</div>
                    </a><a class="w-nav-link nav-link sign-up" target="_blank" href="http://monster2jy.cafe24.com/">HOME</a>
                </nav>
        ...
        <div class="w-container contents">
            <div class="main-heading-wrapper">
                <h1 data-ix="fade-in-heading">Hello,&nbsp;</h1>
                <h1 data-ix="fade-in-heading-2">Front-End</h1>
                <h1 class="without-code" data-ix="fade-in-heading-3">DEVLOPER</h1>
                <h1 class="without-code" data-ix="fade-in-heading-4">JUNYEONG-LEE</h1>
                <div class="w-hidden-small w-hidden-tiny header-1" data-ix="heading-text-load">Everything you see on this page was built visually in <a style="text-decoration: none; color: black;" target="_blank"  href="http://monster2jy.cafe24.com/">R</a>.</div>
            </div>
            <h2 class="main-subtitle" data-ix="subtitle-load">Now you can design interactions and animations for your website without writing a line of code.&nbsp;<a class="link black" href="#more">Learn More</a>&nbsp;or <a class="link black" target="_blank" href="">Start Designing</a>.</h2>
    ...
    <div class="w-nav nav-scroll" data-collapse="small" data-animation="over-right" data-duration="600" data-contain="1" data-ix="display-none-on-load" data-easing="ease-out-quart" data-doc-height="1">
        <div class="w-container nav-scroll-content">
            <a class="w-nav-brand w-clearfix brand" href="" target="_blank">준영짱짱맨<img class="webflow-logo scroll" src="">
                <div class="brand-subtitle"></div>
    ...
    <div class="section" id="more" data-scroll="mid" data-ix="scroll-text-fade-away">
        <div class="w-container">
            <span class="cta-button ex four" data-ix="example-show-sidebar">Making botton</span>
        ...
        <div class="w-container">
            ...
            <div class="w-row">
                ...
                <div class="w-col w-col-6">
                    <a class="w-inline-block video-link" href="" target="_blank" data-ix="circle-play-animation">
                ...
                <div class="w-col w-col-6 right-border">
                    ...
                    <div class="social-wrapper">
                        ...
                        <div class="w-widget w-widget-gplus social-big">
                            <div class="g-plusone" data-href="" data-size="tall" data-annotation="bubble" data-width="120" data-recommendations="false" id="___plusone_0" style="width: 50px; height: 60px;"></div>
                        </div>
                    </div>
                </div>
                <div class="w-col w-col-6">
                    <h2 class="footer-heading">Start Designing</h2>
                    <p class="footer-paragraph">Build your own interactions.</p><a class="cta-button sign-up" target="_blank" href="">Get started</a>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="w-clearfix sidebar" data-ix="sidebar-initial-appearance">
        <h3 class="white-heading">TITLE </h3>
        <p>EXPLAIN, <br>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Suspendisse varius enim in eros elementum tristique. Duis cursus, mi quis viverra ornare, eros dolor interdum nulla, ut commodo diam libero vitae erat.&nbsp;</p><a class="cta-button ex four close" href="#" data-ix="hide-sidebar">✕ &nbsp;Hide Sidebar</a>
    ...
    $(document).ready(function(){
       $('.header_bg').hide();
        $('.header_bg').delay(1500).fadeIn(4000);
